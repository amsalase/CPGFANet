...
class FEANet(nn.Module):
    ...
    def forward(self, input):
        ...
        rgb_aux  = self.atten_SEModule_0(rgb)
        temp_aux = self.atten_SEModule_0(thermal)
        rgb = rgb + temp_aux
        ...
        ######################################################################
        rgb_aux  = self.atten_SEModule_1(rgb)
        temp_aux = self.atten_SEModule_1(thermal)
        rgb = rgb + temp_aux
        thermal = thermal + rgb_aux
        ######################################################################
        ...
        ######################################################################
        rgb_aux  = self.atten_SEModule_2(rgb)
        temp_aux = self.atten_SEModule_2(thermal)
        rgb = rgb + temp_aux
        thermal = thermal + rgb_aux
        ######################################################################
        ...
        ######################################################################
        rgb_aux = self.atten_SEModule_3_1(rgb)
        temp_aux = self.atten_SEModule_3_1(thermal)
        rgb = rgb + temp_aux
        thermal = thermal + rgb_aux
        ######################################################################
        ...
        ######################################################################
        # Des-comentar para usar los bloques RCCAModule en imagen termica y RGB
        rgb_aux = self.atten_SEModule_4_1(rgb)
        temp_aux = self.atten_SEModule_4_1(thermal)
