...
class FEANet(nn.Module):
    ...
    def forward(self, input):
        ...
        temp = self.atten_SEModule_0(thermal)
        ...
        temp = self.atten_SEModule_1(thermal)
        rgb = rgb + temp
        ...
        temp = self.atten_SEModule_2(thermal)
        rgb = rgb + temp
        ######################################################################
        ...
        temp = self.atten_SEModule_3_1(thermal)
        rgb = rgb + temp
        ######################################################################
        ...
        temp = self.atten_SEModule_4_1(thermal)
        fuse = rgb + temp
        ######################################################################
